# Zad 10* (niestandardowe)
# W pliku dane.txt znajduje się 200 wierszy (sprawdź katalog). Każdy wiersz zawiera 320 liczb naturalnych z przedziału
# od 0 do 255, oddzielonych znakami pojedynczego odstępu (spacjami).
# Przedstawiają one jasności kolejnych pikseli czarno-białego obrazu o wymiarach 320 na 200 pikseli
# (od 0 – czarny do 255 – biały). Napisz program(y), który(e) da(dzą) odpowiedzi do poniższych zadań.
# Odpowiedzi zapisz w pliku wyniki6.txt, a każdą odpowiedź poprzedź numerem oznaczającym odpowiednie zadanie.
#
# 10.1
